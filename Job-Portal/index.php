...
<head>
    <meta charset="utf-8">
    <title>InternVsMyself-get daily updates about latest jobs and internships</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.php" class="navbar-brand d-flex align-items-center text-center py-0 px-0 px-lg-1">
                ...
                <h1 class="m-0 text-primary">InternVsMyself</h1>
            </a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>tomasakshi35@gmail.com</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class=" d-inline btn btn-outline-light btn-social" href=""><i class="fab fa-linkedin-in"></i></a>

                    <a class=" d-inline btn btn-outline-light btn-social" href=""><i class="fab fa-telegram"></i></a>
